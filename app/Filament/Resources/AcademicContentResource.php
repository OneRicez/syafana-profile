...
use App\Filament\Resources\AcademicContentResource\Pages;
use App\Filament\Resources\AcademicContentResource\RelationManagers;
...
class AcademicContentResource extends Resource
{
    protected static ?string $model = Content::class;
    protected static ?string $navigationIcon = 'heroicon-o-academic-cap';
    protected static ?string $navigationGroup = 'Content Management';
    protected static ?string $label = 'Academic Management';
    ...
    public static function form(Forms\Form $form): Forms\Form
    {
        return $form->schema([
            ...
            Forms\Components\Hidden::make('page_id') // Sembunyikan agar otomatis diisi
                ->default(fn () => \App\Models\Page::where('name', 'academic')->value('id'))
                ->required(),
...
public static function table(Tables\Table $table): Tables\Table
{
    return $table
        ...
        ->modifyQueryUsing(fn($query) => $query->whereHas('page', fn($q) => $q->where('name', 'academic')))
        ->filters([
    ...
    {
        return [
            'index' => Pages\ListAcademicContents::route('/'),
            'edit' => Pages\EditAcademicContent::route('/{record}/edit'),
        ];
    }
}
