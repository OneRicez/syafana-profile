...
class AboutContentResource extends Resource
{
    ...
    protected static ?string $label = 'About Management';
    ...
    public static function form(Forms\Form $form): Forms\Form
    {
        return $form->schema([
            ...
            Forms\Components\Hidden::make('page_id') // Sembunyikan agar otomatis diisi
                ->default(fn () => \App\Models\Page::where('name', 'about')->value('id'))
                ->required(),
...
public static function table(Tables\Table $table): Tables\Table
{
    return $table
        ...
        ->modifyQueryUsing(fn($query) => $query->whereHas('page', fn($q) => $q->where('name', 'about')))
        ->filters([
