...
<nav role="navigation" aria-label="Pagination Navigation" class="flex justify-between flex-wrap items-center mt-4">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
                <p class="text-sm text-gray-700 leading-5 mx-2">
                    {!! __('Showing') !!}
